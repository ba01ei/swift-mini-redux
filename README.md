...
Here is a [diff view](https://www.diffchecker.com/hxm2TqOS/) between TCA vs Swift Mini Redux. TCA makes it slightly simpler through `.scope()` but the difference is small.
